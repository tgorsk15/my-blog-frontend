            ...
            <section className={dashStyles.addPostSection}>
                <div className={dashStyles.createNewContainer}>
                    <div className={dashStyles.createNewBox}>
                        <h2>Create New</h2>
                        <svg className={dashStyles.addSvg} fill="#000000" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="101px" height="101px" viewBox="0 0 67.201 67.201" xml:space="preserve">
